...
export default async function LandingPage({
  ...
  return (
    <div className="relative flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden text-foreground selection:bg-primary/30">
      <main className="relative z-10 mx-auto flex min-h-0 w-full min-w-0 max-w-4xl flex-1 flex-col overflow-hidden px-4 sm:px-6">
